...
\cvname{Ning Gao} \cvaddress{City Center Plaza, Bellevue}{hhttps://ninggao.github.io/} \cvemail{E-mail: nigao@microsoft.com} \makecvtitle


%%%%%%%%%%%%%%%%%%%%%%
\section{Work Experience}
\begin{CV}
\item[2018--Current] Data Scientist in \textbf{Microsoft}
\end{CV}
\vspace{-1mm}
